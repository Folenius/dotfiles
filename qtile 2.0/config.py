...
# This imports are the modules that, for the sake of being comfortable, and having a perfect organization, 
# I have decided to separate them in different Python files.
# All these modules are in ~/.config/qtile (or the directory where config.py is at).
...
keys = [
    ...
    # [--Configure and modify the layouts as defined below--]
    ...
    Key([mod, alt], "s", lazy.spawn("gnome-screenshot -i"),
...
groups = [Group(i) for i in ["󰈹", "", "󰭻", "", "󰈙", "", "󰝚", "", ""]]
